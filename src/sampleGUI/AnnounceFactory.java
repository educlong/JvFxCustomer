...
public class AnnounceFactory {
    ...
    public static Optional<ButtonType> alertYesNo(String title, String header, String content, String buttonType1,
                                                  String buttonType2, ButtonBar.ButtonData btnData1, ButtonBar.ButtonData btnData2) {
        Alert alert=announcementAlert(Alert.AlertType.CONFIRMATION,title,header, content);
        ButtonType btntpAlert1=new ButtonType(buttonType1, btnData1);
        ButtonType btntpAlert2=new ButtonType(buttonType2, btnData2);
